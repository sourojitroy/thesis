...
(8, 'Sourojit Roy', 'roy.souro2013@gmail.com', '$2y$10$a744.ggBqeydETPIVvexjuhwG5LY9TgL9c99d5ss2Big2U/kxBG5i', '0');
...
CREATE TABLE `question` (
  ...
  `answer_param_1` varchar(100) NOT NULL,
  `answer_param_2` varchar(100) NOT NULL,
  `answer_param_3` varchar(100) NOT NULL,
  `answer_param_4` varchar(100) NOT NULL,
...
CREATE TABLE `registration` (
  `id` int(11) NOT NULL,
  `usernamesignup` varchar(100) NOT NULL,
  `emailsignup` varchar(100) NOT NULL,
  `passwordsignup` varchar(100) NOT NULL,
  `passwordsignup_confirm` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `registration` (`id`, `usernamesignup`, `emailsignup`, `passwordsignup`, `passwordsignup_confirm`) VALUES
(1, 'souro11', 'souro11@gmail.com', '81dcf5ced9b438bed0dad113a893011e', '81dcf5ced9b438bed0dad113a893011e');
