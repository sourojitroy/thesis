...
class Products
{
	...
	public function addQuestion($task_id, $question, $answer_params_1, $answer_params_2, $answer_params_3, $answer_params_4,$right_answer ){
		$query = $this->con->query("INSERT INTO `question`(`task_id`, `question`, `answer_params_1`, `answer_params_2`, `answer_params_3`, `answer_params_4`, `right_answer`) VALUES ('$task_id', 'question', '$answer_params_1',  '$answer_params_2', '$answer_params_3', '$answer_params_4', '$right_answer')");
	
		if ($q) {
			return ['status'=> 202, 'message'=> 'Question is created successfully..!'];
		}
		else{
